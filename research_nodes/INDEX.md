...
- `10_device/11_boot_debian_host.md` — загрузка Debian host на known-good Android kernel
- `10_device/12_device_profile.md` — Device Profile / Hardware Adaptation Description
- `10_device/13_image_tooling.md` — Image / Partition Tooling
...
- `20_runtime/24_android_image_framework_strategy.md` — Android Image / Framework Strategy
...
- `60_platform/62_reproducible_builds.md` — Reproducible Builds / Build Provenance
